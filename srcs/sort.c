...
/*   Updated: 2024/08/20 11:19:05 by jsoares          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	*calc_cost_goo_b(int *tab, t_stack **stack_a, t_stack **stack_b,
		t_stack *tmp_a)
{
	t_aux_sort	aux;
...
void	sort_goo_a(t_stack **stack_a, t_stack **stack_b)
{
	...
	while (stack_size(*stack_b) > 0)
	{
		...
		while (tmp_b)
		{
			tab[aux.row] = calc_cost_goo_a(tab[aux.row], stack_a, stack_b,
					tmp_b);
			tmp_b = tmp_b->next;
			aux.row++;
		}
